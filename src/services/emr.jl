...
"""
add_job_flow_steps(JobFlowId, Steps; aws_config::AbstractAWSConfig=global_aws_config()) =
    emr(
        "AddJobFlowSteps",
...
"""
add_tags(ResourceId, Tags; aws_config::AbstractAWSConfig=global_aws_config()) = emr(
    "AddTags",
...
"""
cancel_steps(ClusterId, StepIds; aws_config::AbstractAWSConfig=global_aws_config()) = emr(
    "CancelSteps",
...
"""
delete_studio(StudioId; aws_config::AbstractAWSConfig=global_aws_config()) = emr(
    "DeleteStudio",
...
"""
describe_cluster(ClusterId; aws_config::AbstractAWSConfig=global_aws_config()) = emr(
    "DescribeCluster",
...
"""
describe_release_label(; aws_config::AbstractAWSConfig=global_aws_config()) =
...
"""
describe_security_configuration(Name; aws_config::AbstractAWSConfig=global_aws_config()) =
    emr(
...
"""
describe_step(ClusterId, StepId; aws_config::AbstractAWSConfig=global_aws_config()) = emr(
    "DescribeStep",
...
"""
describe_studio(StudioId; aws_config::AbstractAWSConfig=global_aws_config()) = emr(
    "DescribeStudio",
    Dict{String,Any}("StudioId" => StudioId);
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
"""
get_block_public_access_configuration(; aws_config::AbstractAWSConfig=global_aws_config()) =
    emr(
...
"""
list_bootstrap_actions(ClusterId; aws_config::AbstractAWSConfig=global_aws_config()) = emr(
...
- `"Marker"`: The pagination token that indicates the next set of results to retrieve.
"""
list_instance_fleets(ClusterId; aws_config::AbstractAWSConfig=global_aws_config()) = emr(
    "ListInstanceFleets",
    Dict{String,Any}("ClusterId" => ClusterId);
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"Marker"`: The pagination token that indicates the next set of results to retrieve.
"""
list_instance_groups(ClusterId; aws_config::AbstractAWSConfig=global_aws_config()) = emr(
    "ListInstanceGroups",
    Dict{String,Any}("ClusterId" => ClusterId);
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"Marker"`: The pagination token that indicates the next set of results to retrieve.
"""
list_instances(ClusterId; aws_config::AbstractAWSConfig=global_aws_config()) = emr(
    "ListInstances",
    Dict{String,Any}("ClusterId" => ClusterId);
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"To"`: The end of time range filter for listing notebook executions. The default is the
  current timestamp.
"""
list_notebook_executions(; aws_config::AbstractAWSConfig=global_aws_config()) =
...
"""
list_release_labels(; aws_config::AbstractAWSConfig=global_aws_config()) =
...
"""
list_security_configurations(; aws_config::AbstractAWSConfig=global_aws_config()) = emr(
...
"""
list_steps(ClusterId; aws_config::AbstractAWSConfig=global_aws_config()) = emr(
    "ListSteps",
    Dict{String,Any}("ClusterId" => ClusterId);
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
"""
list_studio_session_mappings(; aws_config::AbstractAWSConfig=global_aws_config()) =
...
- `"Marker"`: The pagination token that indicates the set of results to retrieve.
"""
list_studios(; aws_config::AbstractAWSConfig=global_aws_config()) =
...
"""
modify_cluster(ClusterId; aws_config::AbstractAWSConfig=global_aws_config()) = emr(
    "ModifyCluster",
    Dict{String,Any}("ClusterId" => ClusterId);
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
"""
modify_instance_groups(; aws_config::AbstractAWSConfig=global_aws_config()) =
...
"""
put_auto_termination_policy(ClusterId; aws_config::AbstractAWSConfig=global_aws_config()) =
    emr(
...
"""
remove_tags(ResourceId, TagKeys; aws_config::AbstractAWSConfig=global_aws_config()) = emr(
    "RemoveTags",
...
- `"VisibleToAllUsers"`:  The VisibleToAllUsers parameter is no longer supported. By
  ...
  Amazon EMR Management Guide.
"""
run_job_flow(Instances, Name; aws_config::AbstractAWSConfig=global_aws_config()) = emr(
    "RunJobFlow",
...
"""
terminate_job_flows(JobFlowIds; aws_config::AbstractAWSConfig=global_aws_config()) = emr(
    "TerminateJobFlows",
...
"""
update_studio(StudioId; aws_config::AbstractAWSConfig=global_aws_config()) = emr(
    "UpdateStudio",
    Dict{String,Any}("StudioId" => StudioId);
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
