...
"""
batch_get_resource_config(resourceKeys; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
...
"""
delete_config_rule(ConfigRuleName; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
        "DeleteConfigRule",
...
delete_organization_conformance_pack(
    ...
    Dict{String,Any}("OrganizationConformancePackName" => OrganizationConformancePackName);
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
)
...
delete_remediation_exceptions(
    ...
    Dict{String,Any}("ConfigRuleName" => ConfigRuleName, "ResourceKeys" => ResourceKeys);
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
)
...
"""
delete_stored_query(QueryName; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
        "DeleteStoredQuery",
...
- `"NextToken"`: The nextToken string returned on a previous page that you use to get the
  next page of results in a paginated response.
"""
describe_aggregation_authorizations(; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
...
- `"NextToken"`: The nextToken string returned on a previous page that you use to get the
  next page of results in a paginated response.
"""
describe_compliance_by_config_rule(; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
...
"""
describe_compliance_by_resource(; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
...
- `"NextToken"`: The nextToken string returned on a previous page that you use to get the
  next page of results in a paginated response.
"""
describe_config_rules(; aws_config::AbstractAWSConfig=global_aws_config()) = config_service(
...
- `"NextToken"`: The nextToken string returned on a previous page that you use to get the
  next page of results in a paginated response.
"""
describe_configuration_aggregators(; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
...
"""
describe_configuration_recorders(; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
...
- `"NextToken"`: The nextToken string returned in a previous request that you use to
  request the next page of results in a paginated response.
"""
describe_conformance_pack_status(; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
...
- `"NextToken"`: The nextToken string returned in a previous request that you use to
  request the next page of results in a paginated response.
"""
describe_conformance_packs(; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
...
"""
describe_delivery_channel_status(; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
...
- `"DeliveryChannelNames"`: A list of delivery channel names.
"""
describe_delivery_channels(; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
...
- `"OrganizationConfigRuleNames"`: The names of organization Config rules for which you
  ...
  organization Config rules.
"""
describe_organization_config_rules(; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
...
- `"NextToken"`: The nextToken string returned on a previous page that you use to get the
  next page of results in a paginated response.
"""
describe_pending_aggregation_requests(; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
...
"""
describe_retention_configurations(; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
...
"""
get_compliance_details_by_resource(; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
...
"""
get_compliance_summary_by_config_rule(; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
...
"""
get_custom_rule_policy(; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
...
"""
get_discovered_resource_counts(; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
...
"""
get_stored_query(QueryName; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
        "GetStoredQuery",
        Dict{String,Any}("QueryName" => QueryName);
        aws_config=aws_config,
...
"""
list_discovered_resources(resourceType; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
...
- `"NextToken"`: The nextToken string returned on a previous page that you use to get the
  next page of results in a paginated response.
"""
list_resource_evaluations(; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
...
- `"NextToken"`: The nextToken string returned in a previous request that you use to
  request the next page of results in a paginated response.
"""
list_stored_queries(; aws_config::AbstractAWSConfig=global_aws_config()) = config_service(
...
- `"Tags"`: An array of tag object.
"""
put_config_rule(ConfigRule; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
        "PutConfigRule",
...
"""
put_delivery_channel(DeliveryChannel; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
        "PutDeliveryChannel",
...
"""
put_evaluations(ResultToken; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
        "PutEvaluations",
...
"""
put_stored_query(StoredQuery; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
        "PutStoredQuery",
...
- `"NextToken"`: The nextToken string returned in a previous request that you use to
  request the next page of results in a paginated response.
"""
select_resource_config(Expression; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
...
- `"ConfigRuleNames"`: The list of names of Config rules that you want to run evaluations
  for.
"""
start_config_rules_evaluation(; aws_config::AbstractAWSConfig=global_aws_config()) =
    config_service(
