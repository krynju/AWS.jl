...
- `bucket`: The bucket name to which the upload was taking place.   Directory buckets -
  ...
  example,  DOC-EXAMPLE-BUCKET--usw2-az2--x-s3). For information about bucket naming
...
requests. For more information, see Amazon S3 Error Best Practices.  You can't use
Content-Type: application/x-www-form-urlencoded for the CompleteMultipartUpload requests.
Also, if you don't provide a Content-Type header, CompleteMultipartUpload can still return
a 200 OK response.  For more information about multipart uploads, see Uploading Objects
Using Multipart Upload in the Amazon S3 User Guide.   Directory buckets - For directory
...
- `bucket`: Name of the bucket to which the multipart upload was initiated.  Directory
  ...
  DOC-EXAMPLE-BUCKET--usw2-az2--x-s3). For information about bucket naming restrictions, see
...
to copy the object to must be enabled for your account.  Amazon S3 transfer acceleration
...
destination bucket is a general purpose bucket, you must have  s3:PubObject  permission to
...
charge for the source if the source storage class bills for data retrieval. For pricing
information, see Amazon S3 pricing.  HTTP Host header syntax   Directory buckets  - The
HTTP Host header syntax is  Bucket_name.s3express-az_id.region.amazonaws.com.   The
following operations are related to CopyObject:    PutObject     GetObject
...
header, then the s3:PutBucketOwnershipControls permission is required.  If your
CreateBucket request sets BucketOwnerEnforced for Amazon S3 Object Ownership and specifies
a bucket ACL that provides access to an external Amazon Web Services account, your request
fails with a 400 error and returns the InvalidBucketAcLWithObjectOwnership error code. For
more information, see Setting Object Ownership on an existing bucket  in the Amazon S3 User
Guide.      S3 Block Public Access - If your specific use case requires granting public
access to your S3 resources, you can disable Block Public Access. Specifically, you can
...
Access, see Blocking public access to your Amazon S3 storage  in the Amazon S3 User Guide.
     Directory bucket permissions - You must have the s3express:CreateBucket permission in
an IAM identity-based policy instead of a bucket policy. Cross-account access to this API
...
One Zone in the Amazon S3 User Guide.  The permissions for ACLs, Object Lock, S3 Object
Ownership, and S3 Block Public Access are not supported for directory buckets. For
directory buckets, all Block Public Access settings are enabled at the bucket level and S3
Object Ownership is set to Bucket owner enforced (ACLs disabled). These settings can't be
modified.  For more information about permissions for creating and working with directory
...
header syntax is s3express-control.region.amazonaws.com.   The following operations are
related to CreateBucket:    PutObject     DeleteBucket
...
"""
create_bucket(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) =
...
- `"x-amz-website-redirect-location"`: If the bucket is configured as a website, redirects
  ...
  supported for directory buckets.
"""
create_multipart_upload(Bucket, Key; aws_config::AbstractAWSConfig=global_aws_config()) =
    s3(
        "POST",
        "/$(Bucket)/$(Key)?uploads";
        aws_config=aws_config,
...
"""
create_session(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) =
...
"""
delete_bucket(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) =
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 403 Forbidden (access denied).
"""
delete_bucket_cors(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) =
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 403 Forbidden (access denied).
"""
delete_bucket_encryption(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "DELETE",
    "/$(Bucket)?encryption";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 403 Forbidden (access denied).
"""
delete_bucket_lifecycle(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "DELETE",
    "/$(Bucket)?lifecycle";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 501 Not Implemented.
"""
delete_bucket_policy(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "DELETE",
    "/$(Bucket)?policy";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 403 Forbidden (access denied).
"""
delete_bucket_replication(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "DELETE",
    "/$(Bucket)?replication";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 403 Forbidden (access denied).
"""
delete_bucket_tagging(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "DELETE",
    "/$(Bucket)?tagging";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 403 Forbidden (access denied).
"""
delete_bucket_website(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "DELETE",
    "/$(Bucket)?website";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
If versioning is enabled, the operation removes the null version (if there is one) of an
object and inserts a delete marker, which becomes the latest version of the object. If
there isn't a null version, Amazon S3 does not remove any objects but will still respond
that the command was successful.   If versioning is suspended or not enabled, the operation
permanently deletes the object.       Directory buckets - S3 Versioning isn't enabled and
...
parameter in the request.    Directory buckets - For directory buckets, you must make
requests for this API operation to the Zonal endpoint. These endpoints support
virtual-hosted-style requests in the format
https://bucket_name.s3express-az_id.region.amazonaws.com/key-name . Path-style requests are
not supported. For more information, see Regional and Zonal endpoints in the Amazon S3 User
...
s3:DeleteObjectVersion  - To delete a specific version of an object from a versiong-enabled
bucket, you must have the s3:DeleteObjectVersion permission.      Directory bucket
...
syntax is  Bucket_name.s3express-az_id.region.amazonaws.com.   The following action is
related to DeleteObject:    PutObject
...
- `"x-amz-request-payer"`:
"""
delete_object(Bucket, Key; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "DELETE",
    "/$(Bucket)/$(Key)";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 403 Forbidden (access denied).
"""
delete_object_tagging(Bucket, Key; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "DELETE",
    "/$(Bucket)/$(Key)?tagging";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"x-amz-sdk-checksum-algorithm"`: Indicates the algorithm used to create the checksum for
  ...
  parameter.
"""
delete_objects(Bucket, Delete; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "POST",
    "/$(Bucket)?delete",
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 403 Forbidden (access denied).
"""
delete_public_access_block(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "DELETE",
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 403 Forbidden (access denied).
"""
get_bucket_acl(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) =
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 403 Forbidden (access denied).
"""
get_bucket_cors(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) =
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 403 Forbidden (access denied).
"""
get_bucket_encryption(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "GET",
    "/$(Bucket)?encryption";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 403 Forbidden (access denied).
"""
get_bucket_lifecycle(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "GET",
    "/$(Bucket)?lifecycle";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
tags, or a combination of both. Accordingly, this section describes the latest API. The
response describes the new filter element that you can use to specify a filter to select a
subset of objects to which the rule applies. If you are using a previous version of the
lifecycle configuration, it still works. For the earlier action, see GetBucketLifecycle.
Returns the lifecycle configuration information set on the bucket. For information about
lifecycle configuration, see Object Lifecycle Management. To use this operation, you must
have permission to perform the s3:GetLifecycleConfiguration action. The bucket owner has
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 403 Forbidden (access denied).
"""
get_bucket_location(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) =
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 403 Forbidden (access denied).
"""
get_bucket_logging(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) =
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 403 Forbidden (access denied).
"""
get_bucket_notification(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "GET",
    "/$(Bucket)?notification";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 403 Forbidden (access denied).
"""
get_bucket_ownership_controls(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) =
    s3(
        "GET",
        "/$(Bucket)?ownershipControls";
        aws_config=aws_config,
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 501 Not Implemented.
"""
get_bucket_policy(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) =
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 403 Forbidden (access denied).
"""
get_bucket_policy_status(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "GET",
    "/$(Bucket)?policyStatus";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 403 Forbidden (access denied).
"""
get_bucket_replication(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "GET",
    "/$(Bucket)?replication";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 403 Forbidden (access denied).
"""
get_bucket_request_payment(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "GET",
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 403 Forbidden (access denied).
"""
get_bucket_tagging(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) =
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 403 Forbidden (access denied).
"""
get_bucket_versioning(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "GET",
    "/$(Bucket)?versioning";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 403 Forbidden (access denied).
"""
get_bucket_website(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) =
...
- `"x-amz-server-side-encryption-customer-key-MD5"`: Specifies the 128-bit MD5 digest of
  ...
  directory buckets.
"""
get_object(Bucket, Key; aws_config::AbstractAWSConfig=global_aws_config()) =
...
- `"x-amz-request-payer"`:
"""
get_object_acl(Bucket, Key; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "GET",
    "/$(Bucket)/$(Key)?acl";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"x-amz-request-payer"`:
"""
get_object_legal_hold(Bucket, Key; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "GET",
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 403 Forbidden (access denied).
"""
get_object_lock_configuration(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) =
    s3(
        "GET",
        "/$(Bucket)?object-lock";
        aws_config=aws_config,
...
- `"x-amz-request-payer"`:
"""
get_object_retention(Bucket, Key; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "GET",
...
- `"x-amz-request-payer"`:
"""
get_object_tagging(Bucket, Key; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "GET",
    "/$(Bucket)/$(Key)?tagging";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"x-amz-request-payer"`:
"""
get_object_torrent(Bucket, Key; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "GET",
    "/$(Bucket)/$(Key)?torrent";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 403 Forbidden (access denied).
"""
get_public_access_block(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "GET",
    "/$(Bucket)?publicAccessBlock";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
message body is not included, so you cannot determine the exception beyond these error
codes.   Directory buckets  - You must make requests for this API operation to the Zonal
...
- `"x-amz-expected-bucket-owner"`: The account ID of the expected bucket owner. If the
  ...
  fails with the HTTP status code 403 Forbidden (access denied).
"""
head_bucket(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) =
...
- `"x-amz-server-side-encryption-customer-key-MD5"`: Specifies the 128-bit MD5 digest of
  ...
  functionality is not supported for directory buckets.
"""
head_object(Bucket, Key; aws_config::AbstractAWSConfig=global_aws_config()) =
...
"""
list_buckets(; aws_config::AbstractAWSConfig=global_aws_config()) =
...
"""
list_directory_buckets(; aws_config::AbstractAWSConfig=global_aws_config()) =
    s3("GET", "/"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"x-amz-request-payer"`:
"""
list_multipart_uploads(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) =
...
- `"x-amz-request-payer"`:
"""
list_object_versions(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) =
...
- `"x-amz-request-payer"`: Confirms that the requester knows that she or he will be charged
  ...
  requests.
"""
list_objects(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) =
...
"""
list_objects_v2(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "GET",
    "/$(Bucket)?list-type=2";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"x-amz-server-side-encryption-customer-key-MD5"`: The MD5 server-side encryption (SSE)
  ...
  Amazon S3 User Guide.  This functionality is not supported for directory buckets.
"""
list_parts(Bucket, Key, uploadId; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "GET",
    "/$(Bucket)/$(Key)",
    Dict{String,Any}("uploadId" => uploadId);
    aws_config=aws_config,
...
- `"x-amz-sdk-checksum-algorithm"`: Indicates the algorithm used to create the checksum for
  ...
  provided ChecksumAlgorithm parameter.
"""
put_bucket_acl(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) =
...
- `"x-amz-sdk-checksum-algorithm"`: Indicates the algorithm used to create the checksum for
  ...
  provided ChecksumAlgorithm parameter.
"""
put_bucket_lifecycle(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "PUT",
    "/$(Bucket)?lifecycle";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
prefix, one or more object tags, or a combination of both. Accordingly, this section
describes the latest API. The previous version of the API supported filtering based only on
an object key name prefix, which is supported for backward compatibility. For the related
API description, see PutBucketLifecycle.   Rules  You specify the lifecycle configuration
in your request body. The lifecycle configuration is specified as XML consisting of one or
more rules. An Amazon S3 Lifecycle configuration can have up to 1,000 rules. This limit is
not adjustable. Each rule consists of the following:   A filter identifying a subset of
objects to which the rule applies. The filter can be based on a key name prefix, object
tags, or a combination of both.   A status indicating whether the rule is in effect.   One
or more lifecycle transition and expiration actions that you want Amazon S3 to perform on
...
explicitly deny permissions. An explicit deny also supersedes any other permissions. If you
...
permissions, see Managing Access Permissions to Your Amazon S3 Resources.   The following
operations are related to PutBucketLifecycleConfiguration:    Examples of Lifecycle
Configuration     GetBucketLifecycleConfiguration     DeleteBucketLifecycle
...
"""
put_bucket_policy(Bucket, Policy; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "PUT",
    "/$(Bucket)?policy",
...
- `"x-amz-sdk-checksum-algorithm"`: Indicates the algorithm used to create the checksum for
  ...
  provided ChecksumAlgorithm parameter.
"""
put_bucket_tagging(Bucket, Tagging; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "PUT",
    "/$(Bucket)?tagging",
...
- `"x-amz-website-redirect-location"`: If the bucket is configured as a website, redirects
  ...
  for directory buckets.
"""
put_object(Bucket, Key; aws_config::AbstractAWSConfig=global_aws_config()) =
...
their email addresses.  x-amz-grant-read: emailAddress=\"xyz@amazon.com\",
...
- `"x-amz-sdk-checksum-algorithm"`: Indicates the algorithm used to create the checksum for
  ...
  provided ChecksumAlgorithm parameter.
"""
put_object_acl(Bucket, Key; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "PUT",
    "/$(Bucket)/$(Key)?acl";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"x-amz-sdk-checksum-algorithm"`: Indicates the algorithm used to create the checksum for
  ...
  provided ChecksumAlgorithm parameter.
"""
put_object_legal_hold(Bucket, Key; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "PUT",
    "/$(Bucket)/$(Key)?legal-hold";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"x-amz-sdk-checksum-algorithm"`: Indicates the algorithm used to create the checksum for
  ...
  provided ChecksumAlgorithm parameter.
"""
put_object_lock_configuration(Bucket; aws_config::AbstractAWSConfig=global_aws_config()) =
    s3(
        "PUT",
        "/$(Bucket)?object-lock";
        aws_config=aws_config,
...
- `"x-amz-sdk-checksum-algorithm"`: Indicates the algorithm used to create the checksum for
  ...
  provided ChecksumAlgorithm parameter.
"""
put_object_retention(Bucket, Key; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "PUT",
    "/$(Bucket)/$(Key)?retention";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
This action performs the following types of requests:     select - Perform a select query
on an archived object    restore an archive - Restore an archived object   For more
information about the S3 structure in the request body, see the following:    PutObject
Managing Access with ACLs in the Amazon S3 User Guide     Protecting Data Using Server-Side
Encryption in the Amazon S3 User Guide    Define the SQL expression for the SELECT type of
...
s.FirstName, s.SSN FROM S3Object s    When making a select request, you can also do the
following:   To expedite your queries, specify the Expedited tier. For more information
...
lifecycle configuration.   You can issue more than one select request on the same Amazon S3
object. Amazon S3 doesn't duplicate requests, so avoid issuing duplicate requests.
Amazon S3 accepts a select request even if the object has already been restored. A select
request doesn’t return error response 409.    Permissions  To use this operation, you
must have permissions to perform the s3:RestoreObject action. The bucket owner has this
permission by default and can grant this permission to others. For more information about
permissions, see Permissions Related to Bucket Subresource Operations and Managing Access
Permissions to Your Amazon S3 Resources in the Amazon S3 User Guide.  Restoring objects
Objects that you archive to the S3 Glacier Flexible Retrieval Flexible Retrieval or S3
Glacier Deep Archive storage class, and S3 Intelligent-Tiering Archive or S3
Intelligent-Tiering Deep Archive tiers, are not accessible in real time. For objects in the
...
the Amazon S3 Standard storage class in your S3 bucket. To access an archived object, you
must restore the object for the duration (number of days) that you specify. For objects in
the Archive Access or Deep Archive Access tiers of S3 Intelligent-Tiering, you must first
initiate a restore request, and then wait until the object is moved into the Frequent
Access tier. To restore a specific object version, you can provide a version ID. If you
don't provide a version ID, Amazon S3 restores the current version. When restoring an
archived object, you can specify one of the following data access tier options in the Tier
element of the request body:     Expedited - Expedited retrievals allow you to quickly
access your data stored in the S3 Glacier Flexible Retrieval Flexible Retrieval storage
class or S3 Intelligent-Tiering Archive tier when occasional urgent requests for restoring
archives are required. For all but the largest archived objects (250 MB+), data accessed
using Expedited retrievals is typically made available within 1–5 minutes. Provisioned
capacity ensures that retrieval capacity for Expedited retrievals is available when you
need it. Expedited retrievals and provisioned capacity are not available for objects stored
...
retrieval option. Standard retrievals typically finish within 3–5 hours for objects
...
Intelligent-Tiering storage classes, enabling you to retrieve large amounts, even
petabytes, of data at no cost. Bulk retrievals typically finish within 5–12 hours for
objects stored in the S3 Glacier Flexible Retrieval Flexible Retrieval storage class or S3
Intelligent-Tiering Archive tier. Bulk retrievals are also the lowest-cost retrieval option
when restoring objects from S3 Glacier Deep Archive. They typically finish within 48 hours
for objects stored in the S3 Glacier Deep Archive storage class or S3 Intelligent-Tiering
Deep Archive tier.    For more information about archive retrieval options and provisioned
...
or Bulk retrievals.)     HTTP Status Code: 503     SOAP Fault Code Prefix: N/A        The
following operations are related to RestoreObject:    PutBucketLifecycleConfiguration
GetBucketNotificationConfiguration
...
- `"x-amz-sdk-checksum-algorithm"`: Indicates the algorithm used to create the checksum for
  ...
  provided ChecksumAlgorithm parameter.
"""
restore_object(Bucket, Key; aws_config::AbstractAWSConfig=global_aws_config()) = s3(
    "POST",
    "/$(Bucket)/$(Key)?restore";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
s3:PubObject  permission to write the object copy to the destination bucket.    For
information about permissions required to use the multipart upload API, see Multipart
