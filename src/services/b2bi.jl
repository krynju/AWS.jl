...
"""
    create_partnership(email, name, profile_id)
    create_partnership(email, name, profile_id, params::Dict{String,<:Any})
...
- `mapping_template`: Specifies the name of the mapping template for the transformer. This
  template is used to convert the input document into the correct set of objects.
...
- `"fileFormat"`: Specifies that the currently supported file formats for EDI
  transformations are JSON and XML.
- `"mappingTemplate"`: Specifies the name of the mapping template for the transformer. This
  template is used to convert the input document into the correct set of objects.
