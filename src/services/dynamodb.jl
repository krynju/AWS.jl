...
"""
batch_execute_statement(Statements; aws_config::AbstractAWSConfig=global_aws_config()) =
    dynamodb(
...
- `"ReturnConsumedCapacity"`:
"""
batch_get_item(RequestItems; aws_config::AbstractAWSConfig=global_aws_config()) = dynamodb(
    "BatchGetItem",
...
"""
batch_write_item(RequestItems; aws_config::AbstractAWSConfig=global_aws_config()) =
    dynamodb(
        "BatchWriteItem",
        Dict{String,Any}("RequestItems" => RequestItems);
        aws_config=aws_config,
...
"""
create_backup(BackupName, TableName; aws_config::AbstractAWSConfig=global_aws_config()) =
    dynamodb(
        "CreateBackup",
...
"""
delete_backup(BackupArn; aws_config::AbstractAWSConfig=global_aws_config()) = dynamodb(
    "DeleteBackup",
...
"""
delete_item(Key, TableName; aws_config::AbstractAWSConfig=global_aws_config()) = dynamodb(
    "DeleteItem",
...
"""
delete_table(TableName; aws_config::AbstractAWSConfig=global_aws_config()) = dynamodb(
    "DeleteTable",
...
"""
describe_backup(BackupArn; aws_config::AbstractAWSConfig=global_aws_config()) = dynamodb(
    "DescribeBackup",
    Dict{String,Any}("BackupArn" => BackupArn);
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
"""
describe_continuous_backups(TableName; aws_config::AbstractAWSConfig=global_aws_config()) =
    dynamodb(
...
describe_endpoints(; aws_config::AbstractAWSConfig=global_aws_config()) =
    dynamodb("DescribeEndpoints"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_export(ExportArn; aws_config::AbstractAWSConfig=global_aws_config()) = dynamodb(
    "DescribeExport",
...
"""
describe_global_table(GlobalTableName; aws_config::AbstractAWSConfig=global_aws_config()) =
    dynamodb(
        "DescribeGlobalTable",
...
"""
describe_import(ImportArn; aws_config::AbstractAWSConfig=global_aws_config()) = dynamodb(
    "DescribeImport",
...
describe_limits(; aws_config::AbstractAWSConfig=global_aws_config()) =
    dynamodb("DescribeLimits"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_table(TableName; aws_config::AbstractAWSConfig=global_aws_config()) = dynamodb(
    "DescribeTable",
    Dict{String,Any}("TableName" => TableName);
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
"""
describe_time_to_live(TableName; aws_config::AbstractAWSConfig=global_aws_config()) =
    dynamodb(
        "DescribeTimeToLive",
        Dict{String,Any}("TableName" => TableName);
        aws_config=aws_config,
...
"""
execute_statement(Statement; aws_config::AbstractAWSConfig=global_aws_config()) = dynamodb(
    "ExecuteStatement",
...
"""
execute_transaction(TransactStatements; aws_config::AbstractAWSConfig=global_aws_config()) =
    dynamodb(
        "ExecuteTransaction",
        Dict{String,Any}(
...
- `"ReturnConsumedCapacity"`:
"""
get_item(Key, TableName; aws_config::AbstractAWSConfig=global_aws_config()) = dynamodb(
    "GetItem",
    Dict{String,Any}("Key" => Key, "TableName" => TableName);
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
list_backups(; aws_config::AbstractAWSConfig=global_aws_config()) =
    dynamodb("ListBackups"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_contributor_insights(; aws_config::AbstractAWSConfig=global_aws_config()) = dynamodb(
...
list_exports(; aws_config::AbstractAWSConfig=global_aws_config()) =
    dynamodb("ListExports"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_global_tables(; aws_config::AbstractAWSConfig=global_aws_config()) =
    dynamodb("ListGlobalTables"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
list_imports(; aws_config::AbstractAWSConfig=global_aws_config()) =
    dynamodb("ListImports"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
list_tables(; aws_config::AbstractAWSConfig=global_aws_config()) =
    dynamodb("ListTables"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: An optional string that, if supplied, must be copied from the output of a
  ...
  page of results.
"""
list_tags_of_resource(ResourceArn; aws_config::AbstractAWSConfig=global_aws_config()) =
    dynamodb(
        "ListTagsOfResource",
...
- `"ReturnValuesOnConditionCheckFailure"`: An optional parameter that returns the item
  ...
  overhead of receiving a larger response. No read capacity units are consumed.
"""
put_item(Item, TableName; aws_config::AbstractAWSConfig=global_aws_config()) = dynamodb(
    "PutItem",
...
"""
query(TableName; aws_config::AbstractAWSConfig=global_aws_config()) = dynamodb(
    "Query",
    Dict{String,Any}("TableName" => TableName);
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
"""
scan(TableName; aws_config::AbstractAWSConfig=global_aws_config()) = dynamodb(
    "Scan",
    Dict{String,Any}("TableName" => TableName);
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"ReturnConsumedCapacity"`: A value of TOTAL causes consumed capacity information to be
  ...
  is valid.
"""
transact_get_items(TransactItems; aws_config::AbstractAWSConfig=global_aws_config()) =
    dynamodb(
        "TransactGetItems",
...
"""
transact_write_items(TransactItems; aws_config::AbstractAWSConfig=global_aws_config()) =
    dynamodb(
        "TransactWriteItems",
        Dict{String,Any}(
...
- `"UpdateExpression"`: An expression that defines one or more attributes to be updated,
  ...
  DynamoDB Developer Guide.
"""
update_item(Key, TableName; aws_config::AbstractAWSConfig=global_aws_config()) = dynamodb(
    "UpdateItem",
    Dict{String,Any}("Key" => Key, "TableName" => TableName);
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"TableClass"`: The table class of the table to be updated. Valid values are STANDARD and
  STANDARD_INFREQUENT_ACCESS.
"""
update_table(TableName; aws_config::AbstractAWSConfig=global_aws_config()) = dynamodb(
    "UpdateTable",
    Dict{String,Any}("TableName" => TableName);
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
