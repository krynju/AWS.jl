...
"""
create_custom_log_source(sourceName; aws_config::AbstractAWSConfig=global_aws_config()) =
    securitylake(
        "POST",
...
# Arguments
- `auto_enable_new_account`: Turns off automatic enablement of Security Lake for member
